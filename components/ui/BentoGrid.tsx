  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "lineat-gradient(90deg, rgba(2,0,36,1) 0%, rgba(59, 59, 69,1) 26%, rgba(93,108,111,1) 100%)",
      }}
    >
      ...
      >
        <div className="font-sans font-normal text-[#c1c2d3] text-xm  md:text-xs lg:text-base z-10">
          {description}
        </div>
